            ...
            <div className="left-custom-menu-adp-wrap comment-scrollbar">
                <nav className="sidebar-nav left-sidebar-menu-pro">
                    <ul className="metismenu" id="menu1">
                        ...
                        <li>
                            <a title="Landing Page" href="events.html" aria-expanded="false"><span className="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> <span className="mini-click-non">Event</span></a>
                        </li>
                        <li>
                            <a className="has-arrow" href="all-professors.html" aria-expanded="false"><span className="educate-icon educate-professor icon-wrap"></span> <span className="mini-click-non">Professors</span></a>
                            <ul className="submenu-angle" aria-expanded="false">
                                <li><a title="All Professors" href="all-professors.html"><span className="mini-sub-pro">All Professors</span></a></li>
                                <li><a title="Add Professor" href="add-professor.html"><span className="mini-sub-pro">Add Professor</span></a></li>
                                <li><a title="Edit Professor" href="edit-professor.html"><span className="mini-sub-pro">Edit Professor</span></a></li>
                                <li><a title="Professor Profile" href="professor-profile.html"><span className="mini-sub-pro">Professor Profile</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a className="has-arrow" href="all-students.html" aria-expanded="false"><span className="educate-icon educate-student icon-wrap"></span> <span className="mini-click-non">Students</span></a>
                            <ul className="submenu-angle" aria-expanded="false">
                                <li><a title="All Students" href="all-students.html"><span className="mini-sub-pro">All Students</span></a></li>
                                <li><a title="Add Students" href="add-student.html"><span className="mini-sub-pro">Add Student</span></a></li>
                                <li><a title="Edit Students" href="edit-student.html"><span className="mini-sub-pro">Edit Student</span></a></li>
                                <li><a title="Students Profile" href="student-profile.html"><span className="mini-sub-pro">Student Profile</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a className="has-arrow" href="all-courses.html" aria-expanded="false"><span className="educate-icon educate-course icon-wrap"></span> <span className="mini-click-non">Courses</span></a>
                            <ul className="submenu-angle" aria-expanded="false">
                                <li><a title="All Courses" href="all-courses.html"><span className="mini-sub-pro">All Courses</span></a></li>
                                <li><a title="Add Courses" href="add-course.html"><span className="mini-sub-pro">Add Course</span></a></li>
                                <li><a title="Edit Courses" href="edit-course.html"><span className="mini-sub-pro">Edit Course</span></a></li>
                                <li><a title="Courses Profile" href="course-info.html"><span className="mini-sub-pro">Courses Info</span></a></li>
                                <li><a title="Product Payment" href="course-payment.html"><span className="mini-sub-pro">Courses Payment</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a className="has-arrow" href="all-courses.html" aria-expanded="false"><span className="educate-icon educate-library icon-wrap"></span> <span className="mini-click-non">Library</span></a>
                            <ul className="submenu-angle" aria-expanded="false">
                                <li><a title="All Library" href="library-assets.html"><span className="mini-sub-pro">Library Assets</span></a></li>
                                <li><a title="Add Library" href="add-library-assets.html"><span className="mini-sub-pro">Add Library Asset</span></a></li>
                                <li><a title="Edit Library" href="edit-library-assets.html"><span className="mini-sub-pro">Edit Library Asset</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a className="has-arrow" href="all-courses.html" aria-expanded="false"><span className="educate-icon educate-department icon-wrap"></span> <span className="mini-click-non">Departments</span></a>
                            <ul className="submenu-angle" aria-expanded="false">
                                <li><a title="Departments List" href="departments.html"><span className="mini-sub-pro">Departments List</span></a></li>
                                <li><a title="Add Departments" href="add-department.html"><span className="mini-sub-pro">Add Departments</span></a></li>
                                <li><a title="Edit Departments" href="edit-department.html"><span className="mini-sub-pro">Edit Departments</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a className="has-arrow" href="mailbox.html" aria-expanded="false"><span className="educate-icon educate-message icon-wrap"></span> <span className="mini-click-non">Mailbox</span></a>
                            <ul className="submenu-angle" aria-expanded="false">
                        ...
                        <li>
                            <a className="has-arrow" href="mailbox.html" aria-expanded="false"><span className="educate-icon educate-interface icon-wrap"></span> <span className="mini-click-non">Interface</span></a>
                            <ul className="submenu-angle interface-mini-nb-dp" aria-expanded="false">
                        ...
                        <li>
                            <a className="has-arrow" href="mailbox.html" aria-expanded="false"><span className="educate-icon educate-charts icon-wrap"></span> <span className="mini-click-non">Charts</span></a>
                            <ul className="submenu-angle chart-mini-nb-dp" aria-expanded="false">
                        ...
                        <li>
                            <a className="has-arrow" href="mailbox.html" aria-expanded="false"><span className="educate-icon educate-data-table icon-wrap"></span> <span className="mini-click-non">Data Tables</span></a>
                            <ul className="submenu-angle" aria-expanded="false">
                        ...
                        <li>
                            <a className="has-arrow" href="mailbox.html" aria-expanded="false"><span className="educate-icon educate-form icon-wrap"></span> <span className="mini-click-non">Forms Elements</span></a>
                            <ul className="submenu-angle form-mini-nb-dp" aria-expanded="false">
                        ...
                        <li>
                            <a className="has-arrow" href="mailbox.html" aria-expanded="false"><span className="educate-icon educate-apps icon-wrap"></span> <span className="mini-click-non">App views</span></a>
                            <ul className="submenu-angle app-mini-nb-dp" aria-expanded="false">
                        ...
                        <li id="removable">
                            <a className="has-arrow" href="#" aria-expanded="false"><span className="educate-icon educate-pages icon-wrap"></span> <span className="mini-click-non">Pages</span></a>
                                        ...
                                        <div className="header-top-menu tabl-d-n">
                                            <ul className="nav navbar-nav mai-top-nav">
                                                ...
                                                <li className="nav-item dropdown res-dis-nn">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" className="nav-link dropdown-toggle">Project <span className="angle-down-topmenu"><i className="fa fa-angle-down"></i></span></a>
                                        ...
                                        <div className="header-right-info">
                                            <ul className="nav navbar-nav mai-top-nav header-right-menu">
                                                <li className="nav-item dropdown">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" className="nav-link dropdown-toggle"><i className="educate-icon educate-message edu-chat-pro" aria-hidden="true"></i><span className="indicator-ms"></span></a>
                                                ...
                                                <li className="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" className="nav-link dropdown-toggle"><i className="educate-icon educate-bell" aria-hidden="true"></i><span className="indicator-nt"></span></a>
                                                    <div role="menu" className="notification-author dropdown-menu animated zoomIn">
                                                        ...
                                                        <ul className="notification-menu">
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div className="notification-icon">
                                                                        <i className="fa fa-cloud edu-cloud-computing-down" aria-hidden="true"></i>
                                                                    </div>
                                                                    <div className="notification-content">
                                                                        <span className="notification-date">16 Sept</span>
                                                                        <h2>Sulaiman din</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div className="notification-icon">
                                                                        <i className="fa fa-eraser edu-shield" aria-hidden="true"></i>
                                                                    </div>
                                                                    <div className="notification-content">
                                                                        <span className="notification-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div className="notification-icon">
                                                                        <i className="fa fa-line-chart edu-analytics-arrow" aria-hidden="true"></i>
                                                                    </div>
                                                                    <div className="notification-content">
                                                                        <span className="notification-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
                                                ...
                                                <li className="nav-item">
                                                    ...
                                                    <ul role="menu" className="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        <li><a href="#"><span className="edu-icon edu-home-admin author-log-ic"></span>My Account</a>
                                                        </li>
                                                        <li><a href="#"><span className="edu-icon edu-user-rounded author-log-ic"></span>My Profile</a>
                                                        </li>
                                                        <li><a href="#"><span className="edu-icon edu-money author-log-ic"></span>User Billing</a>
                                                        </li>
                                                        <li><a href="#"><span className="edu-icon edu-settings author-log-ic"></span>Settings</a>
                                                        </li>
                                                        <li><a href="#"><span className="edu-icon edu-locked author-log-ic"></span>Log Out</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li className="nav-item nav-setting-open"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" className="nav-link dropdown-toggle"><i className="educate-icon educate-menu"></i></a>
                                                        ...
                                                        <div className="tab-content custom-bdr-nt">
                                                            <div id="Notes" className="tab-pane fade in active">
                                                                <div className="notes-area-wrap">
                                                                    <div className="note-heading-indicate">
                                                                        <h2><i className="fa fa-comments-o"></i> Latest Notes</h2>
                                                            ...
                                                            <div id="Projects" className="tab-pane fade">
                                                                <div className="projects-settings-wrap">
                                                                    <div className="note-heading-indicate">
                                                                        <h2><i className="fa fa-cube"></i> Latest projects</h2>
                                                                                    ...
                                                                                    <div className="project-list-flow">
                                                                                        ...
                                                                                        <div className="projects-st-content">
                                                                                            ...
                                                                                            <div className="progress progress-mini">
                                                                                                <div style={{width: '28%'}} className="progress-bar progress-bar-danger hd-tp-1"></div>
                                                                                            </div>
                                                                                ...
                                                                                <a href="#">
                                                                                    <div className="project-list-flow">
                                                                                        ...
                                                                                        <div className="projects-st-content project-rating-cl">
                                                                                            ...
                                                                                            <div className="progress progress-mini">
                                                                                                <div style={{width: "68%;"}} className="progress-bar hd-tp-2"></div>
                                                                                            </div>
                                                                                            <p>Project end: 4:00 pm - 12.06.2014</p>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <a href="#">
                                                                                    <div className="project-list-flow">
                                                                                        ...
                                                                                        <div className="projects-st-content">
                                                                                            ...
                                                                                            <div className="progress progress-mini">
                                                                                                <div style={{width: "78%;"}} className="progress-bar hd-tp-3"></div>
                                                                                            </div>
                                                                                            <p>Project end: 4:00 pm - 12.06.2014</p>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <a href="#">
                                                                                    <div className="project-list-flow">
                                                                                        ...
                                                                                        <div className="projects-st-content project-rating-cl2">
                                                                                            ...
                                                                                            <div className="progress progress-mini">
                                                                                                <div style={{width: "38%;"}} className="progress-bar progress-bar-danger hd-tp-4"></div>
                                                                                            </div>
                                                                                            <p>Project end: 4:00 pm - 12.06.2014</p>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <a href="#">
                                                                                    <div className="project-list-flow">
                                                                                        ...
                                                                                        <div className="projects-st-content">
                                                                                            <p>Completion with: 28%</p>
                                                                                            <div className="progress progress-mini">
                                                                                                <div style={{width: "28%;"}} className="progress-bar progress-bar-danger hd-tp-5"></div>
                                                                                            </div>
                                                                                            <p>Project end: 4:00 pm - 12.06.2014</p>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <a href="#">
                                                                                    <div className="project-list-flow">
                                                                                        ...
                                                                                        <div className="projects-st-content project-rating-cl">
                                                                                            <p>Completion with: 68%</p>
                                                                                            <div className="progress progress-mini">
                                                                                                <div style={{width: "68%;"}} className="progress-bar hd-tp-6"></div>
                                                                                            </div>
                                                                                            <p>Project end: 4:00 pm - 12.06.2014</p>
                                                                                        </div>
                                                                                    </div>
                                                            ...
                                                            <div id="Settings" className="tab-pane fade">
                                                                <div className="setting-panel-area">
                                                                    <div className="note-heading-indicate">
                                                                        <h2><i className="fa fa-gears"></i> Settings Panel</h2>
                            ...
                            <div className="mobile-menu">
                                <nav id="dropdown">
                                    <ul className="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span className="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demoevent" href="#">Professors <span className="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demopro" href="#">Students <span className="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#democrou" href="#">Courses <span className="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demolibra" href="#">Library <span className="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demodepart" href="#">Departments <span className="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demo" href="#">Mailbox <span className="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Miscellaneousmob" href="#">Interface <span className="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Chartsmob" href="#">Charts <span className="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Tablesmob" href="#">Tables <span className="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#formsmob" href="#">Forms <span className="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Appviewsmob" href="#">App views <span className="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Pagemob" href="#">Pages <span className="admin-project-icon edu-icon edu-down-arrow"></span></a>
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div className="analytics-sparkle-line table-mg-t-pro dk-res-t-pro-30">
                            <div className="analytics-content">
                                ...
                                <div className="progress m-b-0">
                                    <div className="progress-bar progress-bar-inverse" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" > <span className="sr-only">230% Complete</span> </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div className="product-sales-chart">
                                ...
                                <div className="row">
                                    <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div className="caption pro-sl-hd">
                                            <span className="caption-subject"><b>University Earnings</b></span>
                                        </div>
                                    </div>
                                    <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <ul className="list-inline cus-product-sl-rp">
                                <li>
                                    <h5><i className="fa fa-circle" ></i>CSE</h5>
                                </li>
                                <li>
                                    <h5><i className="fa fa-circle" ></i>Accounting</h5>
                                </li>
                                <li>
                                    <h5><i className="fa fa-circle" ></i>Electrical</h5>
                                </li>
                            </ul>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div className="single-cards-item">
                            ...
                            <div className="single-product-text">
                                <img src="img/product/pro4.jpg" alt="" />
                                <h4><a className="cards-hd-dn" href="#">Angela Dominic</a></h4>
                                <h5>Web Designer & Developer</h5>
                                <p className="ctn-cards">Lorem ipsum dolor sit amet, this is a consectetur adipisicing elit</p>
                                <a className="follow-cards" href="#">Follow</a>
                                <div className="row">
                                    <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        <div className="cards-dtn">
                                            <h3><span className="counter">199</span></h3>
                                            <p>Articles</p>
                                        </div>
                                    </div>
                                    <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        <div className="cards-dtn">
                                            <h3><span className="counter">599</span></h3>
                                            <p>Like</p>
                                        </div>
                                    </div>
                                    <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        <div className="cards-dtn">
                                            <h3><span className="counter">399</span></h3>
                                            <p>Comment</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="single-review-st-item res-mg-t-30 table-mg-t-pro-n">
                            ...
                            <div className="single-review-st-text">
                                ...
                                <div className="review-item-rating">
                                    <i className="educate-icon educate-star"></i>
                                    <i className="educate-icon educate-star"></i>
                                    <i className="educate-icon educate-star"></i>
                                    <i className="educate-icon educate-star"></i>
                                    <i className="educate-icon educate-star-half"></i>
                                </div>
                            </div>
                            <div className="single-review-st-text">
                        ...
                        <div className="single-product-item res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            ...
                            <div className="single-product-text edu-pro-tx">
                                ...
                                <div className="product-buttons">
                                    <button type="button" className="button-default cart-btn">Read More</button>
                                    <button type="button" className="button-default"><i className="fa fa-heart"></i></button>
                                    <button type="button" className="button-default"><i className="fa fa-share"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row">
                    <div className="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div className="product-sales-chart">
                            ...
                            <ul className="list-inline cus-product-sl-rp">
                                <li>
                                    <h5><i className="fa fa-circle" style={{color: "#006DF0;"}}></i>Python</h5>
                                </li>
                                <li>
                                    <h5><i className="fa fa-circle" style={{color: "#933EC5;"}}></i>PHP</h5>
                                </li>
                                <li>
                                    <h5><i className="fa fa-circle" style={{color: "#65b12d;"}}></i>Java</h5>
                                </li>
                            </ul>
                        ...
                        <div className="white-box res-mg-t-30 table-mg-t-pro-n">
                            ...
                            <ul className="country-state">
                                ...
                                <li>
                                    ...
                                    <div className="progress">
                                        <div className="progress-bar progress-bar-info ctn-vs-2" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" > <span className="sr-only">48% Complete</span></div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div className="progress">
                                        <div className="progress-bar progress-bar-success ctn-vs-3" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" > <span className="sr-only">55% Complete</span></div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div className="progress">
                                        <div className="progress-bar progress-bar-success ctn-vs-4" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" > <span className="sr-only">33% Complete</span></div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div className="progress">
                                        <div className="progress-bar progress-bar-inverse ctn-vs-5" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" > <span className="sr-only">60% Complete</span></div>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div className="courses-inner res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            ...
                            <div className="courses-alaltic">
                                <span className="cr-ic-r"><span className="course-icon"><i className="fa fa-clock"></i></span> 1 Year</span>
                                <span className="cr-ic-r"><span className="course-icon"><i className="fa fa-heart"></i></span> 50</span>
                                <span className="cr-ic-r"><span className="course-icon"><i className="fa fa-dollar"></i></span> 500</span>
                            </div>
                            <div className="course-des">
                                <p><span><i className="fa fa-clock"></i></span> <b>Duration:</b> 6 Months</p>
                                <p><span><i className="fa fa-clock"></i></span> <b>Professor:</b> Jane Doe</p>
                                <p><span><i className="fa fa-clock"></i></span> <b>Students:</b> 100+</p>
                            </div>
                            <div className="product-buttons">
                                <button type="button" className="button-default cart-btn">Read More</button>
                            </div>
